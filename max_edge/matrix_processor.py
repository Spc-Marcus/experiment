...
def process_matrix_with_logging(
    ...
    save_matrix_txt : bool
        Whether to save matrix to text file for visualization
...
def main():
    ...
    parser.add_argument("--no-matrix-txt", action="store_true", 
                       help="Don't save matrix to text file")
    ...
    try:
        ...
        results = process_matrix_with_logging(
            ...
            save_matrix_txt=not args.no_matrix_txt
        )
