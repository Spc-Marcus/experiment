...
def run_pipeline(binary_matrix: np.ndarray, 
                ...
                solver_type: str = "gurobi") -> Dict[str, Any]:  # NEW: Add solver parameter
    """
    ...
    with PipelineTracker() as tracker:
        ...
        results.update({
            ...
            'solver_type': solver_type  # NEW: Track which solver was used
        })
...
def benchmark_pipeline(binary_matrix: np.ndarray, 
    ...
    **kwargs
    ...
    aggregated = {
        ...
        'solver_type': results[0]['solver_type'] if results else 'unknown'  # NEW: Track solver used
    }
