...
def process_matrix_with_logging(
    ...
    save_matrix_txt : bool
        Whether to save matrix to text file for visualization (default: False)
    ...
    final_steps = clustering_full_matrix(
        ...
        log_results=True,
        save_matrix_txt=save_matrix_txt,
...
def main():
    ...
    parser.add_argument("--output", type=str, default="clustering_results.json", 
                       help="Output file for results (default: clustering_results.json)")
    ...
    parser.add_argument("--save-matrix-txt", action="store_true", 
                       help="Save matrix to text file for visualization")
    ...
    try:
        ...
        results = process_matrix_with_logging(
            ...
            save_matrix_txt=args.save_matrix_txt
        )
